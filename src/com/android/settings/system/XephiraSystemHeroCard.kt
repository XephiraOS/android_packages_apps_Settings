...
import com.android.settings.widget.liquidglass.anim.LiquidQuantumCoreVisualizer
import com.android.settings.widget.liquidglass.pureLiquidGlass

@Composable
fun XephiraSystemHeroCard() {
    val isDark = isSystemInDarkTheme()

    val xephiraVersion = remember { SystemProperties.get("ro.xephira.version", "1.0") }
    val primaryColor = Color(0xFF06B6D4)   // Electric Cyan
    ...
    Box(
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1.1f)) {
                ...
                Text(
                    text = "System gestures & orchestration active",
                    fontSize = 13.sp,
            ...
            // Quantum Core Visualizer
            Box(
                modifier = Modifier.size(86.dp),
                contentAlignment = Alignment.Center
            ) {
                LiquidQuantumCoreVisualizer(
